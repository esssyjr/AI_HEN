    ...
    try:
        ...
        messages = [{
            ...
            "content": (
                ...
                f"Note that your diagnoses and recommendations are based on high probability for a prototype system and are not definitive professional diagnoses. Response any language you are spoken with either english, hausa, yoruba or igbo. Make follow up question mandatory. "
            )
        }]
